...
import { clearVersionCache, getCachedVersion, getVersionCacheStatus, refreshVersionCache } from '../Utils/version-cache.js';
declare const makeWASocket: (config: UserFacingSocketConfig) => {
    ...
    updateBussinesProfile: (args: import("../index.js").UpdateBussinesProfileProps) => Promise<any>;
    ...
    requestPlaceholderResend: (messageKey: import("../index.js").WAMessageKey, msgData?: import("../index.js").PlaceholderMessageData) => Promise<string | undefined>;
    ...
    createParticipantNodes: (recipientJids: string[], message: import("../index.js").proto.IMessage, extraAttrs?: import("../index.js").BinaryNode["attrs"], dsmMessage?: import("../index.js").proto.IMessage, useLegacyLock?: boolean) => Promise<{
    ...
    sendAlbumMessage: (jid: string, album: import("../index.js").AlbumMessageOptions, options?: import("../index.js").MiscMessageGenerationOptions) => Promise<import("../index.js").AlbumSendResult>;
    ...
    addLabel: (jid: string, labels: import("../index.js").LabelActionBody) => Promise<void>;
    ...
    addOrEditQuickReply: (quickReply: import("../index.js").QuickReplyAction) => Promise<void>;
    ...
    ev: import("../index.js").BaileysEventEmitter & {
        ...
        destroy(): void;
        isDestroyed(): boolean;
        getStatistics(): import("../index.js").BufferStatistics;
        getConfig(): import("../index.js").BufferConfig;
    };
    authState: {
    ...
    sessionCleanup: {
        start: () => void;
        stop: () => void;
        runCleanup: () => Promise<import("../index.js").SessionCleanupStats>;
        getStats: () => {
            enabled: boolean;
            lastCleanupAt: number;
            cleanupRunning: boolean;
            config: import("../index.js").SessionCleanupConfig;
        };
    };
    ...
    fetchAccountReachoutTimelock: (emitUpdate?: boolean) => Promise<import("../index.js").ReachoutTimelockState>;
    ...
    getUnifiedSessionState: () => Readonly<import("../index.js").UnifiedSessionState> | undefined;
 ...
 * ```
 */
export declare const makeWASocketAutoVersion: (config: UserFacingSocketConfig) => Promise<{
    communityMetadata: (jid: string) => Promise<import("../index.js").GroupMetadata>;
    communityCreate: (subject: string, body: string) => Promise<import("../index.js").GroupMetadata | null>;
    communityCreateGroup: (subject: string, participants: string[], parentCommunityJid: string) => Promise<import("../index.js").GroupMetadata | null>;
    communityLeave: (id: string) => Promise<void>;
