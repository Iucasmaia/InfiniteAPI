...
import type { AlbumMessageOptions, AlbumSendResult, AnyMessageContent, MediaConnInfo, MessageReceiptType, MessageRelayOptions, MiscMessageGenerationOptions, SocketConfig, WAMessage, WAMessageKey } from '../Types/index.js';
...
export declare const makeMessagesSocket: (config: SocketConfig) => {
     ...
     * ```
     */
    sendAlbumMessage: (jid: string, album: AlbumMessageOptions, options?: MiscMessageGenerationOptions) => Promise<AlbumSendResult>;
