...
export declare const makeCommunitiesSocket: (config: SocketConfig) => {
    ...
    updateBussinesProfile: (args: import("../Types/index.js").UpdateBussinesProfileProps) => Promise<any>;
    ...
    requestPlaceholderResend: (messageKey: WAMessageKey, msgData?: import("../Types/index.js").PlaceholderMessageData) => Promise<string | undefined>;
