...
export declare const makeBusinessSocket: (config: SocketConfig) => {
    ...
    createParticipantNodes: (recipientJids: string[], message: import("../index.js").proto.IMessage, extraAttrs?: BinaryNode["attrs"], dsmMessage?: import("../index.js").proto.IMessage, useLegacyLock?: boolean) => Promise<{
        nodes: BinaryNode[];
