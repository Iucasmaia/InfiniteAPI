 ...
 * gateway.
 */
export function suppressLibsignalLogs() {
    if (installed)
        return;
    installed = true;
...
//# sourceMappingURL=suppress-libsignal-logs.js.map