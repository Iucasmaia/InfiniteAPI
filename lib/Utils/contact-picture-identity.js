import { areJidsSameUser, isLidUser, isPnUser, jidNormalizedUser } from '../WABinary/index.js';
/**
 ...
 */
export async function resolveContactPictureIdentity(from, ctx) {
    const result = { id: from };
    if (isLidUser(from)) {
        result.lid = from;
        ...
        const isBogusSelf = !!normalizedPn &&
            !!ctx.meId &&
...
//# sourceMappingURL=contact-picture-identity.js.map