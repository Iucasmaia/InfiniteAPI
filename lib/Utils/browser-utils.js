 ...
 */
const normalizeBrowserKey = (browser) => {
...
export const Browsers = {
    ubuntu: (browser) => ['Ubuntu', browser, OS_VERSIONS.ubuntu],
    macOS: (browser) => ['Mac OS', browser, OS_VERSIONS.macOS],
    windows: (browser) => ['Windows', browser, OS_VERSIONS.windows],
    baileys: (browser) => ['Baileys', browser, OS_VERSIONS.baileys],
    appropriate: (browser) => [getPlatformName(), browser, getAppropriateVersion()],
...
export const isValidBrowserPreset = (value) => {
