...
export declare function aesEncrypt(buffer: Buffer | Uint8Array, key: Uint8Array): Buffer<ArrayBuffer>;
export declare function aesEncrypWithIV(buffer: Buffer | Uint8Array, key: Uint8Array, IV: Uint8Array): Buffer<ArrayBuffer>;
...
export { hkdf, md5 } from './wasm-bridge.js';
