 ...
 */
export declare const resolveLidToPn: (jid: string | undefined | null, lidMapping: LIDMappingStore, logger?: ILogger) => Promise<string | undefined>;
/**
 * Normalizes a WAMessageKey by resolving LID→PN for remoteJid and participant.
 */
export declare const normalizeKeyLidToPn: (key: WAMessageKey, lidMapping: LIDMappingStore, logger?: ILogger) => Promise<void>;
export declare const normalizeMessageJids: (message: WAMessage, signalRepository: SignalRepositoryWithLIDStore, logger?: ILogger) => Promise<void>;
