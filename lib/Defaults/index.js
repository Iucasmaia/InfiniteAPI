...
export const MIN_UPLOAD_INTERVAL = 10000; // 10 seconds minimum between uploads
/**
...
const intFromEnv = (raw, fallback, min = 1) => {
    if (!raw)
        return fallback;
...
export const DEFAULT_SESSION_CLEANUP_CONFIG = {
    ...
    intervalMs: intFromEnv(process.env.BAILEYS_SESSION_CLEANUP_INTERVAL, 86400000), // 24h
